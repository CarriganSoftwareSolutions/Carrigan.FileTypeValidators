...
public class ImageJpegDefinitionTests
{
    ...
    public void ExactTest()
    {
        ...
        Assert.True(definition.WhiteListMatch([0xFF, 0xD8, 0xFF, 0xD9], new("Image", "jPeg"), new FileExtension("jpeg")));
    }
    [Fact]
    public void ExactTest2()
    {
        JpegValidator definition = new();
        Assert.True(definition.WhiteListMatch([0xFF, 0xD8, 0xFF, 0xE0, 0xFF, 0xD9], new("image", "jpeg"), new FileExtension("jfif")));
    }
    [Fact]

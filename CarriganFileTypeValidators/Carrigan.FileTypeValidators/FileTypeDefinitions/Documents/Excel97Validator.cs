...
public class Excel97Validator : FileTypeValidatorBase
{
    ...
    private static readonly ByteSignature Subheader = new([0x09, 0x08, 0x10, 0x00, 0x00, 0x06, 0x05, 0x00], OleSubheaderOffset);

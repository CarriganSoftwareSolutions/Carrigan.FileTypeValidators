...
internal class ImagePjpegDefinition : MimeImageTypeDefinition
{
    private static readonly string subtype = "pjpeg";
    private static readonly MimeType mimeTypeEnumMimeTypeEnum = Enums.MimeType.ImagePjpeg;
